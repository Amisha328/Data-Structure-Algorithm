...
Given a square matrix A of dimensions N×N.
find the minimum number of operations required to make it special. 
...
int minOperations(vector<vector<int>> &mat, int n){
     ...
     long long maxVal = max(*max_element(sumRow.begin(), sumRow.end()),
